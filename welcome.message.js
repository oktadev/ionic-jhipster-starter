...
The JHipster Starter ships with login and signup that will work with a JHipster backend with JWT Authentication. It also contains an entity blueprint that allows you to generate Ionic pages. 
